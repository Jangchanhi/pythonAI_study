...
plt.scatter(bream_length, bream_weight) # 도미 데이터 표현
plt.scatter(smelt_length,smelt_weight) # 빙어 데이터 표현
plt.xlabel('length')
plt.ylabel('weight')
plt.show()

# 도미와 빙어 합치기    도미 35개 // 빙어 14개
length = bream_length+smelt_length
weight = bream_weight+smelt_weight

# 사이킷런이 기대하는 데이터 형태 49개의 생선
# 리스트 내포
